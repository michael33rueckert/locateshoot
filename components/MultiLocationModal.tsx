...
export default function MultiLocationModal({
  ...
  return (
    <>
      <div onClick={onClose} className="anim-backdrop-in" style={{ position: 'fixed', inset: 0, background: 'rgba(26,22,18,.6)', backdropFilter: 'blur(6px)', zIndex: 1700 }} />
      <div className="anim-modal-in" style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', background: 'white', borderRadius: 16, width: 460, maxWidth: '94vw', padding: '1.75rem', zIndex: 1800, boxShadow: '0 24px 64px rgba(0,0,0,.3)' }}>

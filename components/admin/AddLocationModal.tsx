...
export default function AddLocationModal({ onClose, onCreate }: {
  ...
  return (
    <>
      ...
      <div className="anim-modal-in" style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', background: 'white', borderRadius: 12, width: 640, maxWidth: '94vw', maxHeight: '92svh', overflow: 'hidden', zIndex: 5001, boxShadow: '0 24px 64px rgba(0,0,0,.3)', display: 'flex', flexDirection: 'column' }}>

...
export default function LocationEditModal({ loc, onClose, onSave }: {
  ...
  return (
    <>
      ...
      <div className="anim-modal-in" style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', background: 'white', borderRadius: 12, width: 620, maxWidth: '94vw', maxHeight: '92svh', overflowY: 'auto', zIndex: 5001, boxShadow: '0 24px 64px rgba(0,0,0,.3)' }}>

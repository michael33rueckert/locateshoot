...
const SECTIONS = [
  ...
  },
  {
    eyebrow: 'Step 3',
    icon:    '📌',
    title:   'Use permanent links for your booking workflow',
    body:    `Permanent links are reusable — one URL you can drop anywhere. The three big ones:`,
    bullets: [
      `🔗 Share entire portfolio — auto-syncs with every new location you add. Perfect if you want every client to see everything.`,
      `🧭 Multi-location link — same, but lets clients pick 2+ spots with an optional "max miles apart" cap so they stay inside your session window.`,
      `📌 Custom permanent link — hand-pick a subset of portfolio locations and reuse the link across many clients.`,
    ],
    cta:     { href: '/dashboard', label: 'Create a permanent link →' },
  },
  {
    eyebrow: 'Step 4',
    icon:    '⚙',
    title:   'Wire it into HoneyBook, Dubsado, or any booking tool',
    body:    `Your permanent link is just a URL — which means it drops into anything. Put it in your HoneyBook project page, embed it in the proposal PDF, link it from a Dubsado workflow email, or stick it in your Calendly confirmation. Every time a client picks, you get an email with their choice and they show up in your dashboard.`,
    bullets: [
